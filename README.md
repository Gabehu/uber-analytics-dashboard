...
- Daily log entry (hours, trips, fare, tips, promotions, wallet balance, notes)
- Odometer-based mileage tracking and time tracking (online vs. real work time)
- Selected-day view with earnings breakdown and rule-based labels (e.g. "promo-carried," "strong hourly")
...
- Quest tracker (bonus tiers, trips remaining, push/stop recommendation)
- Spending/wallet leakage tracker
- "Cushion" tracker (obligations vs. real savings)
- Import tools for weekly/monthly statements